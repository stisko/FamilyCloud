            ...
            <div class="repeat" id="editfamilyrepeat" style="display:none">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="datetime" class="form-control" id="editfamilyrepeatstart" oninput="style_inp('editfamilyrepeatstart')"  name="editfamilyrepeatstart" placeholder="YYYY-MM-DD HH:MM:SS" value="${event.startRepeatDate}" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31)) (0[0-9]|1[0-9]|2[0-3])(:[0-5][0-9]){2}" required/><span>Invalid Datetime input</span>
                        <span class="input-group-editon">to</span>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="datetime" class="form-control" id="editfamilyexpiresat" oninput="style_inp('editfamilyexpiresat')" name="editfamilyexpiresat" placeholder="YYYY-MM-DD HH:MM:SS" value="${event.endRepeatDate}" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31)) (0[0-9]|1[0-9]|2[0-3])(:[0-5][0-9]){2}" required/><span>Invalid Datetime input</span>
                        <span class="input-group-editon">to</span>
                    </div>
                </div>
            </div>
